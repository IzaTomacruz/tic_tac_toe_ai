...
class Game(Constants):
    ...
    def show_lines(self):
        ...
        pygame.draw.line(self.screen, self.line_color, (self.width - self.square_size, 0), (self.width - self.square_size, self.height), self.line_width)
        #For horizontal
        pygame.draw.line(self.screen, self.line_color, (0, self.square_size), (self.width, self.square_size), self.line_width)
        pygame.draw.line(self.screen, self.line_color, (0, self.height - self.square_size), (self.width, self.height - self.square_size), self.line_width)

    def next_turn(self):
        self.player = self.player % 2 + 1

game_instance = FullGame()
game_instance.loop()
